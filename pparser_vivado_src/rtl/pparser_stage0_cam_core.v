...
module pparser_stage0_cam_core (
    input  wire        clk,
    input  wire        rst,
    input  wire [16:0] cmp_din,
    output wire        ready,
    output wire        match,
    ...
    reg [16:0] cam_data_init [0:15];
    reg [16:0] cam_mask_init [0:15];

    initial begin
        $readmemb("pparser_stage0_cam_data.mif", cam_data_init);
        $readmemb("pparser_stage0_cam_mask.mif", cam_mask_init);
    end
